...
public class alienShipType2 extends AlienShip{
    alienShipType2(int gameScreenX, int gameScreenY, int x, int y) {
        super(gameScreenX, gameScreenY, x, y);
        
        try {
            alienShipImage = ImageIO.read(new FileImageInputStream(new File("alienShip2.png")));
